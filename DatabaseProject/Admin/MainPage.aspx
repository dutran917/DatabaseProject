<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="MainPage.aspx.cs" Inherits="DatabaseProject.Admin.MainPage" %>
                ...
                <ItemTemplate>
                    <div style="display:table-row">
                        <div style="display:table-cell">
                            <a href="Remove.aspx?id=<%#Eval("post_id") %>"><img src="../Images/x.png" width="20" height="20"/></a>
                        </div>
                        <div style="display:table-cell">
